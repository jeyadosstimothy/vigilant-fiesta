...
public class Vgg64 extends CudaRun {
...
public Vgg64() {
super("src/main/java/deepdsl/gen/vgg64");
...
// fc8_B = ((Sum(m4) * -0.1) + (fc8_B * (1 + (5.0E-4 * -0.1))))
m4.sum(fc8_B, lrn_rate, 1f + decay * lrn_rate);
// val m2 = (i54) => fc8_W[@, i54]
JCudaMatrix m2 = fc8_W.asMatrix(1, false);
// val m6 = (i22) => X105[@, i22]
JCudaMatrix m6 = X105.asMatrix(1, false);
// fc8_W = ((m4 * m6 * -0.1) + (fc8_W * (1 + (5.0E-4 * -0.1))))
m4.times(m6, fc8_W, lrn_rate, 1f + decay * lrn_rate);
// dealloc X105
X105.free();
...
// fc7_B = ((Sum(m1) * -0.1) + (fc7_B * (1 + (5.0E-4 * -0.1))))
m1.sum(fc7_B, lrn_rate, 1f + decay * lrn_rate);
// val m3 = (i47) => fc7_W[@, i47]
JCudaMatrix m3 = fc7_W.asMatrix(1, false);
// val m8 = (i26) => X102[@, i26]
JCudaMatrix m8 = X102.asMatrix(1, false);
// fc7_W = ((m1 * m8 * -0.1) + (fc7_W * (1 + (5.0E-4 * -0.1))))
m1.times(m8, fc7_W, lrn_rate, 1f + decay * lrn_rate);
// dealloc X102
X102.free();
...
// fc6_B = ((Sum(m9) * -0.1) + (fc6_B * (1 + (5.0E-4 * -0.1))))
m9.sum(fc6_B, lrn_rate, 1f + decay * lrn_rate);
...
// fc6_W = ((m9 * m10 * -0.1) + (fc6_W * (1 + (5.0E-4 * -0.1))))
m9.times(m10, fc6_W, lrn_rate, 1f + decay * lrn_rate);
...
// dealloc X97
X97.free();
// cv53_B = ((X305 * d_Convolv(1,1)()/d_cv53_B * -0.1) + (cv53_B * (1 + (5.0E-4 * -0.1))))
y7.backward_bias(X305, cv53_B, lrn_rate, 1f + decay * lrn_rate);
// val X302 = X305 * d_Convolv(1,1)(cv53_W)/d_X95
JCudaTensor X302 = y7.backward_data(X305, cv53_W);
// cv53_W = ((X305 * d_Convolv(1,1)(X95)/d_cv53_W * -0.1) + (cv53_W * (1 + (5.0E-4 * -0.1))))
y7.backward_filter(X305, X95, cv53_W, lrn_rate, 1f + decay * lrn_rate);
// dealloc X305
X305.free();
...
// dealloc X95
X95.free();
// cv52_B = ((X336 * d_Convolv(1,1)()/d_cv52_B * -0.1) + (cv52_B * (1 + (5.0E-4 * -0.1))))
y7.backward_bias(X336, cv52_B, lrn_rate, 1f + decay * lrn_rate);
// val X275 = X336 * d_Convolv(1,1)(cv52_W)/d_X93
JCudaTensor X275 = y7.backward_data(X336, cv52_W);
// cv52_W = ((X336 * d_Convolv(1,1)(X93)/d_cv52_W * -0.1) + (cv52_W * (1 + (5.0E-4 * -0.1))))
y7.backward_filter(X336, X93, cv52_W, lrn_rate, 1f + decay * lrn_rate);
// dealloc X336
X336.free();
...
// dealloc X93
X93.free();
// cv51_B = ((X271 * d_Convolv(1,1)()/d_cv51_B * -0.1) + (cv51_B * (1 + (5.0E-4 * -0.1))))
y7.backward_bias(X271, cv51_B, lrn_rate, 1f + decay * lrn_rate);
// val X342 = X271 * d_Convolv(1,1)(cv51_W)/d_X91
JCudaTensor X342 = y7.backward_data(X271, cv51_W);
// cv51_W = ((X271 * d_Convolv(1,1)(X91)/d_cv51_W * -0.1) + (cv51_W * (1 + (5.0E-4 * -0.1))))
y7.backward_filter(X271, X91, cv51_W, lrn_rate, 1f + decay * lrn_rate);
// dealloc X271
X271.free();
...
// dealloc X90
X90.free();
// cv43_B = ((X278 * d_Convolv(1,1)()/d_cv43_B * -0.1) + (cv43_B * (1 + (5.0E-4 * -0.1))))
y10.backward_bias(X278, cv43_B, lrn_rate, 1f + decay * lrn_rate);
// val X292 = X278 * d_Convolv(1,1)(cv43_W)/d_X88
JCudaTensor X292 = y10.backward_data(X278, cv43_W);
// cv43_W = ((X278 * d_Convolv(1,1)(X88)/d_cv43_W * -0.1) + (cv43_W * (1 + (5.0E-4 * -0.1))))
y10.backward_filter(X278, X88, cv43_W, lrn_rate, 1f + decay * lrn_rate);
// dealloc X278
X278.free();
...
// dealloc X88
X88.free();
// cv42_B = ((X282 * d_Convolv(1,1)()/d_cv42_B * -0.1) + (cv42_B * (1 + (5.0E-4 * -0.1))))
y10.backward_bias(X282, cv42_B, lrn_rate, 1f + decay * lrn_rate);
// val X344 = X282 * d_Convolv(1,1)(cv42_W)/d_X86
JCudaTensor X344 = y10.backward_data(X282, cv42_W);
// cv42_W = ((X282 * d_Convolv(1,1)(X86)/d_cv42_W * -0.1) + (cv42_W * (1 + (5.0E-4 * -0.1))))
y10.backward_filter(X282, X86, cv42_W, lrn_rate, 1f + decay * lrn_rate);
// dealloc X282
X282.free();
...
// dealloc X86
X86.free();
// cv41_B = ((X274 * d_Convolv(1,1)()/d_cv41_B * -0.1) + (cv41_B * (1 + (5.0E-4 * -0.1))))
y11.backward_bias(X274, cv41_B, lrn_rate, 1f + decay * lrn_rate);
// val X329 = X274 * d_Convolv(1,1)(cv41_W)/d_X84
JCudaTensor X329 = y11.backward_data(X274, cv41_W);
// cv41_W = ((X274 * d_Convolv(1,1)(X84)/d_cv41_W * -0.1) + (cv41_W * (1 + (5.0E-4 * -0.1))))
y11.backward_filter(X274, X84, cv41_W, lrn_rate, 1f + decay * lrn_rate);
// dealloc X274
X274.free();
...
// dealloc X83
X83.free();
// cv33_B = ((X301 * d_Convolv(1,1)()/d_cv33_B * -0.1) + (cv33_B * (1 + (5.0E-4 * -0.1))))
y14.backward_bias(X301, cv33_B, lrn_rate, 1f + decay * lrn_rate);
// val X352 = X301 * d_Convolv(1,1)(cv33_W)/d_X81
JCudaTensor X352 = y14.backward_data(X301, cv33_W);
// cv33_W = ((X301 * d_Convolv(1,1)(X81)/d_cv33_W * -0.1) + (cv33_W * (1 + (5.0E-4 * -0.1))))
y14.backward_filter(X301, X81, cv33_W, lrn_rate, 1f + decay * lrn_rate);
// dealloc X301
X301.free();
...
// dealloc X81
X81.free();
// cv32_B = ((X296 * d_Convolv(1,1)()/d_cv32_B * -0.1) + (cv32_B * (1 + (5.0E-4 * -0.1))))
y14.backward_bias(X296, cv32_B, lrn_rate, 1f + decay * lrn_rate);
// val X327 = X296 * d_Convolv(1,1)(cv32_W)/d_X79
JCudaTensor X327 = y14.backward_data(X296, cv32_W);
// cv32_W = ((X296 * d_Convolv(1,1)(X79)/d_cv32_W * -0.1) + (cv32_W * (1 + (5.0E-4 * -0.1))))
y14.backward_filter(X296, X79, cv32_W, lrn_rate, 1f + decay * lrn_rate);
// dealloc X296
X296.free();
...
// dealloc X79
X79.free();
// cv31_B = ((X323 * d_Convolv(1,1)()/d_cv31_B * -0.1) + (cv31_B * (1 + (5.0E-4 * -0.1))))
y15.backward_bias(X323, cv31_B, lrn_rate, 1f + decay * lrn_rate);
// val X280 = X323 * d_Convolv(1,1)(cv31_W)/d_X77
JCudaTensor X280 = y15.backward_data(X323, cv31_W);
// cv31_W = ((X323 * d_Convolv(1,1)(X77)/d_cv31_W * -0.1) + (cv31_W * (1 + (5.0E-4 * -0.1))))
y15.backward_filter(X323, X77, cv31_W, lrn_rate, 1f + decay * lrn_rate);
// dealloc X323
X323.free();
...
// dealloc X76
X76.free();
// cv22_B = ((X269 * d_Convolv(1,1)()/d_cv22_B * -0.1) + (cv22_B * (1 + (5.0E-4 * -0.1))))
y18.backward_bias(X269, cv22_B, lrn_rate, 1f + decay * lrn_rate);
// val X338 = X269 * d_Convolv(1,1)(cv22_W)/d_X74
JCudaTensor X338 = y18.backward_data(X269, cv22_W);
// cv22_W = ((X269 * d_Convolv(1,1)(X74)/d_cv22_W * -0.1) + (cv22_W * (1 + (5.0E-4 * -0.1))))
y18.backward_filter(X269, X74, cv22_W, lrn_rate, 1f + decay * lrn_rate);
// dealloc X269
X269.free();
...
// dealloc X74
X74.free();
// cv21_B = ((X315 * d_Convolv(1,1)()/d_cv21_B * -0.1) + (cv21_B * (1 + (5.0E-4 * -0.1))))
y19.backward_bias(X315, cv21_B, lrn_rate, 1f + decay * lrn_rate);
// val X316 = X315 * d_Convolv(1,1)(cv21_W)/d_X72
JCudaTensor X316 = y19.backward_data(X315, cv21_W);
// cv21_W = ((X315 * d_Convolv(1,1)(X72)/d_cv21_W * -0.1) + (cv21_W * (1 + (5.0E-4 * -0.1))))
y19.backward_filter(X315, X72, cv21_W, lrn_rate, 1f + decay * lrn_rate);
// dealloc X315
X315.free();
...
// dealloc X71
X71.free();
// cv12_B = ((X266 * d_Convolv(1,1)()/d_cv12_B * -0.1) + (cv12_B * (1 + (5.0E-4 * -0.1))))
y22.backward_bias(X266, cv12_B, lrn_rate, 1f + decay * lrn_rate);
// val X319 = X266 * d_Convolv(1,1)(cv12_W)/d_X69
JCudaTensor X319 = y22.backward_data(X266, cv12_W);
// cv12_W = ((X266 * d_Convolv(1,1)(X69)/d_cv12_W * -0.1) + (cv12_W * (1 + (5.0E-4 * -0.1))))
y22.backward_filter(X266, X69, cv12_W, lrn_rate, 1f + decay * lrn_rate);
// dealloc X266
X266.free();
...
// dealloc X69
X69.free();
// cv11_B = ((X347 * d_Convolv(1,1)()/d_cv11_B * -0.1) + (cv11_B * (1 + (5.0E-4 * -0.1))))
y23.backward_bias(X347, cv11_B, lrn_rate, 1f + decay * lrn_rate);
// cv11_W = ((X347 * d_Convolv(1,1)(X257)/d_cv11_W * -0.1) + (cv11_W * (1 + (5.0E-4 * -0.1))))
y23.backward_filter(X347, X257, cv11_W, lrn_rate, 1f + decay * lrn_rate);
// dealloc X347
X347.free();
// dealloc X257
X257.free();

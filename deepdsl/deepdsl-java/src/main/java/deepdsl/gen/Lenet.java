...
// V_cv2_W = ((X86 * d_Convolv(1,0)(X24)/d_cv2_W * -0.01) + (V_cv2_W * 0.1))
...
// V_cv2_B = ((X86 * d_Convolv(1,0)()/d_cv2_B * -0.01) + (V_cv2_B * 0.1))
...
// dealloc X23
X23.free();
// V_cv1_W = ((X77 * d_Convolv(1,0)(X67)/d_cv1_W * -0.01) + (V_cv1_W * 0.1))
...
// V_cv1_B = ((X77 * d_Convolv(1,0)()/d_cv1_B * -0.01) + (V_cv1_B * 0.1))
